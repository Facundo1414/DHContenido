...
public class BD {
    ...
    private static final String SQL_DROP_CREATE_ODONTOLOGO= "DROP TABLE IF EXISTS ODONTOLOGOS; CREATE TABLE ODONTOLOGOS " +
            "(ID INT AUTO_INCREMENT PRIMARY KEY, NUMERO_MATRICULA INT NOT NULL ,NOMBRE VARCHAR(30) NOT NULL, APELLIDO VARCHAR(20) NOT NULL)";
    private static final String SQL_PRUEBA_ODONTOLOGOS="INSERT INTO ODONTOLOGOS(NUMERO_MATRICULA,NOMBRE,APELLIDO) VALUES (000000000 ,'NOMBREPRUEBA', 'APELLIDOPRUEBA'),(000000001, 'NOMBRE2', 'APELLIDO2')";
