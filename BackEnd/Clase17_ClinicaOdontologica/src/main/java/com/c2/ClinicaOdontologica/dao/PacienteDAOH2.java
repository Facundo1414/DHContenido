...
public class PacienteDAOH2 implements iDao<Paciente>{
    ...
    public void eliminar(Integer id) {
        ...
        try{
            ...
            //Hay que eliminar el domicilio para eliminarlo posteriormente
            PreparedStatement psSelectOne= connection.prepareStatement(SQL_SELECT_BY);
            psSelectOne.setInt(1,id);
            ResultSet rs= psSelectOne.executeQuery();
            DomicilioDAOH2 daoAux= new DomicilioDAOH2();
            ...
            // ahora si procedo a eliminar Domicilio y Paciente
            assert domicilio != null;
            daoAux.eliminar(domicilio.getId());

            PreparedStatement preparedStatement1 = connection.prepareStatement(SQL_DELETE);
