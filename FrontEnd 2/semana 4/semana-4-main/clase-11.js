...
function validarInformacion(usuario) {
    ...
    cleanedStr = usuario.password.replace(/\s/g, ''); // Elimina todos los espacios en blanco, incluidos los no estándar
    if (cleanedStr.length < 6) errores.push("La contraseña debe tener al menos 6 caracteres, entre letras y símbolos.")
